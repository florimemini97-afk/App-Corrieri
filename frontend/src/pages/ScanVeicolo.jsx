    ...
    <div className="min-h-screen bg-gradient-to-b from-green-500 to-green-700 flex flex-col items-center justify-center p-6">
      <div className="bg-white rounded-2xl shadow-xl p-8 w-full max-w-sm text-center">
        {stato === 'confirm' && <>
          ...
          <p className="text-gray-500 text-sm mb-6">Stai prendendo il veicolo come<br /><strong className="text-gray-700">{corriere.nome} {c
cat > /app/frontend/src/pages/ScanVeicolo.jsx << 'EOF'
import { useState, useEffect } from 'react'
import { useParams, useNavigate } from 'react-router-dom'
import { checkout } from '../api'
